...
import 'package:kangy_flutter/src/screens/Detail.dart';
import 'package:kangy_flutter/src/screens/SignIn.dart';

import 'dart:math';

import 'package:kangy_flutter/src/screens/swipe/Personal.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
        ...
        child: Stack(
          children: <Widget>[
            ...
            Container(
              // color: Colors.green,
              alignment: Alignment.bottomLeft,
              margin: EdgeInsets.only(left: 10, bottom: 55),
            ...
            Container(
              // color: Colors.red,
              alignment: Alignment.bottomLeft,
              margin: EdgeInsets.only(left: 10, bottom: 75),
    ...
    return Scaffold(
            ...
            children: <Widget>[
                ...
                Container(
                  ...
                  child: DrawerHeader(
                    ...
                    child: Container(
                      margin: EdgeInsets.only(top: 0, left: 0, right: 10, bottom: 10),
                      // color: Colors.red,
              ...
              GestureDetector(
                onTap: () => {
                  Navigator.of(context, rootNavigator: true).pushReplacement(MaterialPageRoute(builder: (context) => new SignInScreen())),
        ...
        //Add Our TitleBar instead Default AppBar ------------------------------
              ...
              // scrollDirection: Axis.vertical,
                ...
                child: Column(
                    children: [
                      ...
                      Container(
                          height: 105 + 56 + _appConfig.rH(24) + 297 + _appConfig.rH(48), //
                ...
                // margin:  EdgeInsets.only(left: 20, right: 20),
                  ...
                  child: Row (
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () { print("Container was tapped1"); },
                          child: Container(
                            width: 36,
                            height: 36,
                            // color: Colors.green,
    ...
    return Row(
      children: [
        ...
        GestureDetector(
          ...
          //   ),
          // ),
          onTap: () => Navigator.of(context, rootNavigator: true).pushReplacement(MaterialPageRoute(builder: (context) => new DetailScreen())),
